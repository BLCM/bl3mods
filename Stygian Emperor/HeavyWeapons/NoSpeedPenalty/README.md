No Heavy Weapon Player Speed Penalty
------------------------------------
Created by **Stygian Emperor**

Removes player movement speed reduction from heavy weapons which cause it. (only Atlas and Vladof ones from what I can tell.)

Credits
-------
- **Apocalyptech** for pretty much immediately finding the correct files to edit when I was asked if anyone happened to know where player movement speed was reduced by heavy weapons.
