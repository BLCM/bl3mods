...
mod = Mod('all_weapons_can_anoint.bl3hotfix',
        ...
        [
            ...
            "Better Loot for that.)  Excludes The Shoddy, but includes a",
            "grenade and a couple shields which needed attention as well.",
        ],
...
# (get_anoints_code.py).  Grenade+Shield bits were added by hand, though.
...
anointments = [
        ...
        # Base game Shield Generics
        ('/Game/Gear/Weapons/_Shared/_Design/EndGameParts/_Generic/SkillEnd_DamageReduction/GPart_All_SkillEnd_DamageReduction', GENERIC, {SH}),
        ('/Game/Gear/Weapons/_Shared/_Design/EndGameParts/_Generic/SkillEnd_CooldownRate/GPart_All_SkillEnd_CooldownRate', GENERIC, {SH}),
        ('/Game/Gear/Weapons/_Shared/_Design/EndGameParts/_Generic/SkillEnd_MoveSpeed/GPart_All_SkillEnd_MoveSpeed', GENERIC, {SH}),
        ('/Game/Gear/Weapons/_Shared/_Design/EndGameParts/_Generic/SkillEnd_HealthRegen/GPart_All_SkillEnd_HealthRegen', GENERIC, {SH}),

        # Base game Shield Beastmaster
        ('/Game/Gear/Weapons/_Shared/_Design/EndGameParts/Character/Beastmaster/AttackCommandMovespeed/GPart_Beast_AttackCmd_Movespeed', BEASTMASTER, {SH}),
        ('/Game/Gear/Weapons/_Shared/_Design/EndGameParts/Character/Beastmaster/RakkAttackCharge/GPart_Beast_RakkCharge', BEASTMASTER, {SH}),
        ('/Game/Gear/Weapons/_Shared/_Design/EndGameParts/Character/Beastmaster/StealthNova/GPart_Beast_ExitStealthNova', BEASTMASTER, {SH}),

        # Base game Shield Gunner
        ('/Game/Gear/Weapons/_Shared/_Design/EndGameParts/Character/Gunner/Exit_ShieldMaxHealth/GPart_Gunner_ShieldHealthMax', GUNNER, {SH}),
        ('/Game/Gear/Weapons/_Shared/_Design/EndGameParts/Character/Gunner/EnterExit_Nova/GPart_Gunner_EnterExit_Nova', GUNNER, {SH}),
        ('/Game/Gear/Weapons/_Shared/_Design/EndGameParts/Character/Gunner/Exit_KillsLowerCooldown/GPart_Gunner_KillsLowerCooldown', GUNNER, {SH}),

        # Base game Shield Operative
        ('/Game/Gear/Weapons/_Shared/_Design/EndGameParts/Character/Operative/BarrierDeployShieldRecharge/GPart_Operative_BarrierDeploy_ShieldRecharge', OPERATIVE, {SH}),
        ('/Game/Gear/Weapons/_Shared/_Design/EndGameParts/Character/Operative/CloneActiveHealthRegen/GPart_Operative_CloneActive_HealthRegen', OPERATIVE, {SH}),
        ('/Game/Gear/Weapons/_Shared/_Design/EndGameParts/Character/Operative/DroneActiveMovespeed/GPart_Operative_DroneActiveMovespeed', OPERATIVE, {SH}),

        # Base game Shield Siren
        ('/Game/Gear/Weapons/_Shared/_Design/EndGameParts/Character/Siren/Grasp_ConstantNova/GPart_Siren_Grasp_ConstantNova', SIREN, {SH}),
        ('/Game/Gear/Weapons/_Shared/_Design/EndGameParts/Character/Siren/Slam_DamageReduction/GPart_Siren_Slam_DamageReduction', SIREN, {SH}),
        ('/Game/Gear/Weapons/_Shared/_Design/EndGameParts/Character/Siren/Slam_ReturnDamage/GPart_Siren_Slam_ReturnDamage', SIREN, {SH}),
        ('/Game/Gear/Weapons/_Shared/_Design/EndGameParts/Character/Siren/Slam_MeleeDamage/GPart_Siren_Slam_MeleeDamage', SIREN, {SH}),

        # Base game Shield - One more Generic which shows up at the end
        # (putting it here so that they show up in the same order as everywhere else)
        ('/Game/Gear/Weapons/_Shared/_Design/EndGameParts/_Generic/SkillEnd_MeleeDamage/GPart_All_SkillEnd_MeleeDamage', GENERIC, {SH}),
...
weapons = [
        ...
        ("Starkiller",
           ...
           MAL_PS),
        # Superstreamer *can* anoint but it's anoint-locked (which is defeated by the Raid1+Event2 additions)
        ("Superstreamer",
        ...
        ("Faulty Star",
            ...
            '/Game/PatchDLC/Alisma/Gear/Shields/_Uniques/FaultyStar/Balance/PartSet_Shield_Legendary_FaultyStar',
            SH),
        ("Scream of Terror",
            '/Game/PatchDLC/BloodyHarvest/Gear/Shields/_Design/_Unique/ScreamOfPain/Balance/InvBalD_Shield_ScreamOfTerror',
            '/Game/PatchDLC/BloodyHarvest/Gear/Shields/_Design/_Unique/ScreamOfPain/Balance/PartSet_Shield_ScreamOfTerror',
            SH),
        ]
...
for (label, balance, partset, weap_type) in sorted(weapons):
    ...
    # For some reason the Faulty Star hotfixes don't like to apply properly with
    # Mod.PATCH -- they end up *blanking out* the generic parts lists, rather than
    # adding anything in.  It actually ends up breaking even the Raid1+Event2
    # anointment expansions.  Using a LEVEL based hotfix works for the Balance
    # but weirdly still blanks out the PartSet.  Fortunately, by that time, only
    # the Balance matters, so it happens to still work anyway.  Still: weird.
    if label == 'Faulty Star':
        hf_type = Mod.LEVEL
        hf_target = 'MatchAll'
    else:
        hf_type = Mod.PATCH
