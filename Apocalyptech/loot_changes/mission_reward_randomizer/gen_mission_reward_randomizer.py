...
mod = Mod('mission_reward_randomizer.bl3hotfix',
...
for (mission_obj, drop_type) in [
        ...
        ('/Game/Missions/Plot/Mission_Ep05_OvercomeHQBlockade.Default__Mission_Ep05_OvercomeHQBlockade_C:RewardData_OakMissionRewardData', CM),
        ...
        ('/Game/Missions/Side/Zone_0/Prologue/Mission_Scoopers_Bully.Default__Mission_Scoopers_Bully_C:RewardData_OakMissionRewardData', PS),
        ...
        ('/Game/Missions/Side/Zone_2/MarshFields/Mission_RockOnPandora.Default__Mission_RockOnPandora_C:RewardData_OakMissionRewardData', GM),
        ...
        ('/Game/PatchDLC/Alisma/Missions/Plot/ALI_EP02.Default__ALI_EP02_C:RewardData_OakMissionRewardData', AR),
        ('/Game/PatchDLC/Alisma/Missions/Plot/ALI_EP03.Default__ALI_EP03_C:RewardData_OakMissionRewardData', SH),
        ...
        ('/Game/PatchDLC/Alisma/Missions/Side/ALI_SM_AllShapesAndCalibers.Default__ALI_SM_AllShapesAndCalibers_C:RewardData_OakMissionRewardData', SM),
        ...
        ('/Game/PatchDLC/Ixora2/Missions/Side/Mission_Ixora_Main04.Default__Mission_Ixora_Main04_C:RewardData_OakMissionRewardData', AF),
        ]:
