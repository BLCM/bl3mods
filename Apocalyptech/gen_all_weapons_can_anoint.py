...
# TODO: The Ghast Call grenade also can't anoint, though it's also not legitimately
# acquireable when Bloody Harvest isn't active.  Since it'd mean basically adding
# a whole new bit to here, I'm not gonna bother for now.
