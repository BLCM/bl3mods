...
mod=Mod('B3&2_RescaledMayhem_LessWorldDrop.bl3hotfix',
'Borderlands 3&2',
'Grimm',
[
    ...
    'Changes in this version only : Mayhem has been rescaled, m11 is now a bit harder than m10, but you still use the same gear. No more modifiers, no more anoints, the world drop has been reduced to be more similar to BL2 and TPS,you no longer get bonus loot from mayhem, the dedicated loot has been untouched.',
...
if True:
    ...
    if True:
        ...
        mod.comment('Action Skill Scaling')
        if True:
        ...
        mod.comment('Passive Skill Scaling')
        if True:
        ...
        mod.comment('Environmental Damage Scaling')
        if True:
        ...
        mod.comment('Mayhem Global World Drop')
        if True:
        ...
        mod.comment('Mayhem Exp And Cash Gain')
        if True :
            mPATCH=1
            while mPATCH <= 11:
