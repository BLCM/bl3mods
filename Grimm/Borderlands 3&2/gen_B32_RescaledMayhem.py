...
mod=Mod('B3&2_RescaledMayhem.bl3hotfix',
'Borderlands 3&2',
'Grimm',
[
    ...
    'Changes in this version only : Mayhem has been rescaled, m11 is now a bit harder than m10, but you still use the same gear. No more modifiers, no more anoints, the loot stays close to the same, you still get a lot of legendaries.',
