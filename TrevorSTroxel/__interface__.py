...
if __name__ == "__main__":
    ...
    text2 = Button(text="2. Choose File", font=("Times New Roman", 18), command = test1)
    text3 = Button(text="3. Find All References", font=("Times New Roman", 18), command = test1)
    text4 = Button(text="4. Make Regular Hotfix", font=("Times New Roman", 18), command = test1)
