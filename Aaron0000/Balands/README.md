...
Improved attack command cooldown by 50%.
 ┗----Rationale: Attack Command is one of those things seldom used because you can only use them once in a while. A reduction in cooldown should remedy that.
